...
limit = openapi.Parameter(
    "limit", openapi.IN_QUERY, type=openapi.TYPE_NUMBER, default=20
)

basket_data = openapi.Parameter(
    "data", openapi.IN_QUERY, type=openapi.TYPE_OBJECT, value={"id": 123, "count": 5, "product_count": 10}
)

order_id = openapi.Parameter(
    "id", openapi.IN_PATH, type=openapi.TYPE_STRING, description="order id"
)
